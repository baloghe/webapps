...
public class Board {
	...
	public static int getCellRow(int inCellNum){
		return inCellNum / COLNUM;
	}
	
	public static int getCellColumn(int inCellNum){
		return inCellNum % ROWNUM;
	}
	
	public ArrayList<Integer> getFreeCells(){
		ArrayList<Integer> ret = new ArrayList<Integer>();
		for(int i=0; i<ROWNUM*COLNUM; i++){
			int col = getCellColumn(i);
